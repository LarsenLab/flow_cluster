---
title: "Workflow to analyze Flow Cytometry Data"
...
p <- plot_ly(adapt_clusters_cd19_pos_tsne, 
             x=~.tsne1, 
             y=~.tsne2, 
             z=~.tsne3, 
...
adapt_clusters_cd19_neg <- adapt |> 
    filter(population == "CD19-") |>
    tof_cluster(method = "flowsom", 
                cluster_cols = all_of(clust_cols_neg), 
                num_metaclusters = 6) 
```
...
#### Visualize Clusters in 2 and 3 dimension
