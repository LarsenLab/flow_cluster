---
title: "Workflow to prepare Flow Cytometry Data"
...
##### Step 1: Load and Read FCS Data with tidytof
...
##### Step 2: Create Sample Metadata Variables
...
-   Identify the markers of interests

-   Transform with asinh (cofactor =150 for flow and 5 for cytof )

-   Scale (validate if it includes centering too)
...
write_rds(adapt,"data/proc/adapt.rds")

write_rds(channel_cols, "data/proc/channel_cols.rds")
```
